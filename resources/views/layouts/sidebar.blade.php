...
<head>
  ...
  <!-- Favicons -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">  <link href="../assets/img/favicon.png" rel="icon">
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{url('reclamation')}}">
          <i class="bi bi-file-text"></i>                   
          <span>users</span>
        </a>
      </li>

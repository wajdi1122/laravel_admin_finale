                  ...
                  <table class="table table-striped">
                      ...
                      @foreach($Organizer as $row)
                          <tr>
                              ...
                              <td><form action="{{url('deleteorganizer/'.$row->id)}}" method="post">
                                      @csrf
                                      @method('DELETE')
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                              <form action="{{url('updatetorganizer/'.$row->id)}}" method="post" enctype="multipart\data">
                                  @csrf
                                  @method('PUT')
                                  <div class="mb-3">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form action="{{url('ajouterorganizer')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Src</label>
